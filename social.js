function socialStart(){
    ...
    var gUrl = 'https://plus.google.com/100520130082816551481/posts';
    ...
    if(config.landing_url && config.landing_url.trim() != ''){//globalni
        ...
        if(config.webstoreId && config.webstoreId.trim() != ''){
            gUrl = 'https://chrome.google.com/webstore/detail/' + config.webstoreId;
    ...
    document.getElementById('share-google-obal').innerHTML = '<div class="g-plusone" id="share-gplus" data-size="medium" data-href="' + gUrl + '"></div>';
